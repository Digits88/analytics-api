...
function queryCurrentViews(ctx) {
    ...
    return {
        size: 0,
        query: util.filter([util.createdBetween(timestamp), util.includingSiteGroups(ovp.getSiteGroupId(ctx)), util.includingSites(ovp.getSites(ctx)), util.includeVods(params.vod)]),
        aggs: {
            sitegroups: {
                terms: {
